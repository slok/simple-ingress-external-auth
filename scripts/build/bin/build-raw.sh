...
version_path="github.com/slok/simple-ingress-external-auth/internal/info.Version"
src=./cmd/simple-ingress-external-auth
out=./bin/simple-ingress-external-auth
